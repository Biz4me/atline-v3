...
export default function MailPostChat() {
  const { messages, input, handleInputChange, handleSubmit, isLoading } = useChat({
    api: '/api/mailpost/chat',
    initialMessages: [
      {
        id: 'welcome',
        role: 'assistant',
        content:
          'Bonjour ! Je suis MailPost, votre assistant email. Que puis-je faire pour vous ? (envoyer un mail, consulter votre boîte, gérer les newsletters, vider la corbeille…)',
      },
    ],
  });
